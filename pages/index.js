...
export default function Home() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('https://gm2kcw3s21.execute-api.us-east-1.amazonaws.com/register', jsonPayload, {
        headers: {
  ...
  return (
    <div className="max-w-screen-md mx-auto">
        <img src='https://assets.awsugecuador.com/assets/banner1.png'/><br/>
        <div className="max-w-screen-md max-w-md p-4 shadow-xl">
        <h1 style={{color: '#f8991d'}} className="text-2xl font-semibold mb-4 text-center">Formulario de Registro</h1>
  ...
  {formData.country === 'Ecuador' ? (
    ...
    />
          ...
          <div className="mb-4">
            <label htmlFor="userType" className="block text-gray-700">Profesión:</label>
            <select
              id="userType"
              name="userType"
          ...
          {formData.userType === 'Estudiante' && (
            <div className="mb-4">
              <label htmlFor="university" className="block text-gray-700">Universidad:</label>
              <input
                type="text"
                id="company"
                name="company"
          ...
          {formData.userType !== 'Estudiante' && (
            <div className="mb-4">
              <label htmlFor="company" className="block text-gray-700">Empresa:</label>
              <input
                type="text"
                id="company"
                name="company"
  ...
  <label htmlFor="terms" className="block text-gray-700">
    ...
    />
    Acepto los términos y condiciones del AWS UG Ecuador y el Código de conducta del evento.<br/>
    Revisa aquí nuestro <a style={{color: '#f8991d'}} href='https://communityday.awsecuador.com/codigo-de-conducta/' target='_blank'>Código de conducta</a> y <a style={{color: '#f8991d'}} href='https://communityday.awsecuador.com/terminos-y-condiciones/' target='_blank'>Términos y condiciones</a>
  </label>
</div>
